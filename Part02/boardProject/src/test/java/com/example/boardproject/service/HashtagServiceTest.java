...
/*
* @Mock으로 등록하면 @InjectMocks에 해당 목이 들어감
*
* @MethodSource
* @ParameterizedTest를 하면 어떤 식으로 테스트 소스 (값)들을 넣어줘야 할 지 정해줘야 함
* 어노테이션 방식으로도 할 수 있다. @MethodSource는 매소드 방식으로 주입하는 방법
* */
...
public class HashtagServiceTest {
    ...
    @DisplayName("해시태그 이름들을 입력하면, 저장된 해시태그 중에 매칭하는 것들을 중복 없이 반환한다.")
    @Test
