...
// dependency가 필요하면 mocking을 하도록 하겠다. -> mokito
...
//    정렬 기능
    ...
    void givenHashtag_whenSearchingArticlesViaHashTag_thenReturnsArticlesPage() {
        ...
        // When
        Page<ArticleDto> articles = sut.searchArticlesViaHashtag(hashtagName, pageable); // 제목, 본문, ID, 닉네임, 해시태그
        // Then
    ...
    void givenModifiedArticleInfo_whenUpdatingArticle_thenUpdatesArticle() {
        ...
        assertThat(article)
                ...
                .extracting("hashtags",
                        Assertions.as(InstanceOfAssertFactories.COLLECTION))
                .hasSize(1)
    ...
    private Article createArticle(Long id) {
        ...
        ReflectionTestUtils.setField(article, "id", id);        return article;
    }
